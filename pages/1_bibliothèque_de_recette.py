                ...
                if st.session_state.selected_recipe == recipe.recipe_id:
                    ...
                    st.markdown(
                        ...
                        <div style="
                            ...
                            color: #FFFFFF;
                        ">
                        <h2 style="color: #4A90E2; margin-top: 0;">🍽️ {recipe.name}</h2>
                        """,
                        unsafe_allow_html=True
                    )
                    ...
                    with col1:
                        st.markdown(f'<p style="color: #E0E0E0;">{recipe.description}</p>', unsafe_allow_html=True)

                        st.markdown('<h3 style="color: #66B2FF; border-bottom: 1px solid #333; padding-bottom: 5px;">🥘 Ingredients</h3>', unsafe_allow_html=True)
                        for ing in recipe.ingredients:
                            st.markdown(f'<p style="color: #E0E0E0;">- {ing.formatted_quantity()} {ing.unit} {ing.name} {ing.notes}</p>', unsafe_allow_html=True)

                        st.markdown('<h3 style="color: #66B2FF; border-bottom: 1px solid #333; padding-bottom: 5px;">📝 Instructions</h3>', unsafe_allow_html=True)
                        for j, step in enumerate(recipe.instructions, 1):
                            st.markdown(f'<p style="color: #E0E0E0;">{j}. {step}</p>', unsafe_allow_html=True)
                    ...
                    # Action buttons
                    st.markdown('<h3 style="color: #66B2FF;">⚡ Actions</h3>', unsafe_allow_html=True)
